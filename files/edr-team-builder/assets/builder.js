...
function weeklyState(){
  ...
  if(!w.seeded){   // first open: tick the twelve the team actually races
    WEEKLY_SERIES.forEach(function(s){ if(w.series[s.n]===undefined) w.series[s.n]=!!s.on; });
    w.seeded=true;
  }
  return w;
}

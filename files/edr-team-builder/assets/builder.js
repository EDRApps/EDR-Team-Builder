...
function renderWeekly(){
  ...
  h+='<div class="meta" style="margin-top:4px">Pick the series to cover, hit Generate, then copy the draft out and add your own flare. '
...
document.getElementById('content').addEventListener('input',function(e){
  if(!e.target||!e.target.dataset||e.target.dataset.action!=='wkq') return;
  _wkQ=e.target.value||'';
